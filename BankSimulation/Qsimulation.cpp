...
// Precondition: Inputfile is a textfile of arrival and transaction 
// times, E is the current event list.
// Postcondition: Event read from Inputfile and inserted into E. At 
// end-of-file, does nothing to E.
// Calls: Einsert.
// File: Inputfile.
// -------------------------------------------------------------- 
{
